...
Supersedes [supervisor#10](0010-before-1-0-the-caution-window-shifts-by-one.md)
wholly. Partly supersedes
[supervisor#8](0008-artefacts-are-paired-by-contract-major.md) and
[supervisor#9](0009-major-upgrades-are-never-automatic.md): their shape stands and
...
[supervisor#9](0009-major-upgrades-are-never-automatic.md) made caution depend on the size of a change in **the artefact's own
version** — a major of the Platform or the Shell is never activated unattended.
[supervisor#10](0010-before-1-0-the-caution-window-shifts-by-one.md) then asked how to read that version before 1.0 and shifted the window
...
[supervisor#10](0010-before-1-0-the-caution-window-shifts-by-one.md) went further and asserted that a contract minor bump before 1.0 is not
...
- **A contract change is the risky upgrade**, at any artefact version — it is
  ...
  unattended, exactly as [supervisor#9](0009-major-upgrades-are-never-automatic.md) describes, with the subject corrected.
...
- **The same component decides compatibility.** [supervisor#8](0008-artefacts-are-paired-by-contract-major.md) pairs the Platform and
...
and it is the shape [supervisor#9](0009-major-upgrades-are-never-automatic.md) left behind. A Platform can certainly change what
...
it is [supervisor#10](0010-before-1-0-the-caution-window-shifts-by-one.md)'s position and the `ClientProfile` incident is the counterexample.
...
- **Automation becomes useful before 1.0, which [supervisor#10](0010-before-1-0-the-caution-window-shifts-by-one.md) could not manage.**
...
- **Cutting patch releases stops being necessary.** [supervisor#10](0010-before-1-0-the-caution-window-shifts-by-one.md)'s consequence — that
